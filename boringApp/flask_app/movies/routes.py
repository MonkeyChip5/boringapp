...
#     img = get_b64_img(user.username) if user.profile_pic else None
#     reviews = Review.objects(commenter=user)

#     return render_template("user_detail.html", error=None, image=img, username=username, reviews=reviews)
